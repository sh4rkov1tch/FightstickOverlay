...
CApp::CApp(const char* strCfgPath):
    m_vecButtons(),
    m_pStick(nullptr)
{
    ...
    _PushButtonsToVector(strCfgPath);
...
void CApp::_PushButtonsToVector(const char* strCfgPath){
    ...
    m_pStick = new CStick(0, cfgParser.GetStickInputMode(), Vector2{854/6, 480/2}, Color{245, 245, 245, 220}, RAYWHITE);
